...
start_local_host() {
  ...
  (
    ...
    [[ -n "${JIANDANLY_LOCAL_ROUTING:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_ROUTING=$JIANDANLY_LOCAL_ROUTING")
    ...
    [[ -n "${JIANDANLY_LOCAL_MEMORY_WRITE:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_MEMORY_WRITE=$JIANDANLY_LOCAL_MEMORY_WRITE")
    [[ -n "${JIANDANLY_LOCAL_MEMORY_RECALL:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_MEMORY_RECALL=$JIANDANLY_LOCAL_MEMORY_RECALL")
    [[ -n "${JIANDANLY_LOCAL_MEMORY_TTL_DAYS:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_MEMORY_TTL_DAYS=$JIANDANLY_LOCAL_MEMORY_TTL_DAYS")
    [[ -n "${JIANDANLY_LOCAL_SKILLS_ENABLED:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_SKILLS_ENABLED=$JIANDANLY_LOCAL_SKILLS_ENABLED")
    [[ -n "${JIANDANLY_LOCAL_SKILLS_PATH:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_SKILLS_PATH=$JIANDANLY_LOCAL_SKILLS_PATH")
    [[ -n "${JIANDANLY_LOCAL_SKILLS_ISOLATE:-}" ]] && env_cmd+=("JIANDANLY_LOCAL_SKILLS_ISOLATE=$JIANDANLY_LOCAL_SKILLS_ISOLATE")
