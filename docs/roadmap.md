...
### P2 — 产品体验 + 质量护城河
功能/体验:
- [ ] 消息级操作:重试/重新生成、编辑重发、删除(现只有复制)(功能 · 高 · M)
- [ ] 会话搜索(逻辑已写好,入口被注释掉 + 搜正文)(功能 · 高 · M)
- [ ] 忘记密码/重置 + 邮箱验证(i18n key 都在但从未渲染)(功能 · 高 · M)
- [ ] 代码块语法高亮 + 单块复制(主打 Code 但 markdown 没覆盖 code/pre)(功能 · 中 · M)
- [ ] 桌面通知(失焦时 run.completed/failed 弹系统通知)(功能 · 中 · S)
- [ ] 每轮用量透明(本轮花了多少积分/token/工具次数 + 花费历史)(功能 · 中 · S)
