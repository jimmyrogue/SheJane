...
- Source SVG: `client/src/shared/assets/logo.svg`.
- Renderer asset: `client/src/shared/assets/logo.png`.
- Electron assets: `client/electron/assets/app-icon.*`, `client/electron/assets/app-tray*.png`.
