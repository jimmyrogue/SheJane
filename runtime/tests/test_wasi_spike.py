...
from shejane_runtime.plugins.executor import WasiActionExecutor
from shejane_runtime.plugins.wasi import WASI_MAX_BUFFERED_INPUT_BYTES, WasiResourceLimitError

REPO_ROOT = Path(__file__).resolve().parents[2]
COMPONENT = (
    REPO_ROOT / "runtime" / "plugins" / "fixtures" / "wasi-archive" / "payload" / "archive.wasm"
)
INVOCATION = (
    REPO_ROOT / "runtime" / "plugins" / "fixtures" / "wasi-archive" / "examples" / "invocation.json"
)
