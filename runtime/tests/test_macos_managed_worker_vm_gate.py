...
from shejane_runtime.plugins.guest_disk import Ext4ImageTool
from shejane_runtime.plugins.guest_image import build_linux_initramfs
from shejane_runtime.plugins.macos_vm import MacOSVMResources, load_macos_vm_resources
from shejane_runtime.plugins.managed_worker import (
    WorkerProtocolError,
...
GUESTD = ROOT / "runtime/src/shejane_runtime/plugins/guestd/main.go"
WORKER = ROOT / "runtime/tests/fixtures/managed_worker_linux/main.go"
NODE_WORKER = ROOT / "runtime/tests/fixtures/managed_worker_node"
RUNTIME_CRASH_DRIVER = ROOT / "runtime/tests/fixtures/macos_vm_runtime_crash.py"
