...
def main() -> None:
    ...
    entrypoint = (
        "payload/documents-worker.exe"
        if args.platform.startswith("windows/")
        else "payload/documents-worker"
    )
