...
Darwin and Linux/arm64 builds freeze Python 3.12, RapidOCR 3.9.1, ONNX Runtime 1.27.0,
PP-OCRv6 medium detection/recognition models, and the small PP-OCRv4 orientation
classifier. Runtime inference uses that exact classifier for 180-degree orientation
and permits only `CPUExecutionProvider`.
...
binutils, and complete package/model input set.
