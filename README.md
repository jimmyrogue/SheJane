...
| Extensions | Skills, MCP servers, deterministic WASI/Managed Worker plugins, fixed macOS Computer Use, Browser QA, and local macOS/Windows OCR capabilities, subagents, and configurable middleware |
