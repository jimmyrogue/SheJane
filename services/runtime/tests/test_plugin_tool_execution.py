...
from local_host.plugins.catalog import PluginCatalog
from local_host.plugins.executor import ManagedWorkerActionExecutor
from local_host.plugins.identity import (
    plugin_action_catalog_hash,
    plugin_action_tool_version,
)
from local_host.plugins.manifest import load_plugin_manifest
from local_host.plugins.package import canonical_package_digest
from local_host.plugins.tools import PluginActionError, PluginToolAdapter
from local_host.server import create_app
from local_host.store.sqlite import LocalStore
from local_host.tools.runtime import RuntimeToolExecution, current_runtime_tool_execution
...
async def test_plugin_adapter_maps_worker_progress_to_custom_stream(
    ...
    monkeypatch.setattr("local_host.plugins.tools.get_stream_writer", lambda: streamed.append)
