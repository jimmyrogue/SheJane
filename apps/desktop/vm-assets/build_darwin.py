...
from local_host.plugins.guest_image import build_linux_initramfs  # noqa: E402

LOCK_PATH = Path(__file__).with_name("darwin-arm64.lock.json")
GUESTD_SOURCE = RUNTIME_ROOT / "local_host" / "plugins" / "guestd" / "main.go"
    ...
    payload = {
        ...
        "build": {
            ...
            "launcher_source_sha256": file_identity(
                ROOT / "apps/desktop/native/managed-worker-vm.swift"
            )[1],
